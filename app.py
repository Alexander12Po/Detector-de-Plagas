...
# Flask) — probamos ambas rutas, en ese orden, para que funcione sin
# importar cuál de las dos estructuras use el proyecto.
...
def home():
    ...
    return error_response(
        "No se encontró index.html (ni en templates/ ni junto a app.py) en el servidor.",
        status=500,
