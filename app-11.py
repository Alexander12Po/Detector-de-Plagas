...
# Carpeta donde vive este archivo (app.py). Servimos index.html leyéndolo
# directamente desde aquí en vez de usar render_template("index.html"),
# porque render_template exige que el archivo esté dentro de una carpeta
# "templates/" — si index.html está junto a app.py (como en este proyecto),
# Flask no lo encuentra y la página cae con "Error interno del servidor.".
...
def home():
    ...
    if not os.path.exists(index_path):
        return error_response(
            "No se encontró index.html junto a app.py en el servidor.",
            status=500,
